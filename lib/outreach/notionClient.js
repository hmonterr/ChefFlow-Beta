 ...
 *
 * All reads/writes go through this module — nothing else should import @notionhq/client directly.
 */
...
/**
 * Returns all Chef Leads pages as normalised lead objects.
 */
...
/**
 * Fetches a single lead by Notion page ID.
 * @param {string} pageId
 */
...
/**
 * Updates fields on an existing lead page.
 * Only keys present in `updates` are written — others are left untouched.
 * @param {string} pageId
 * @param {Object} updates
 */
async function updateLead(pageId, updates) {
...
module.exports = { getAllLeads, getLead, createLead, updateLead };
