 ...
 * DB ID: dd28d06a-b2c8-4962-838c-a82707b1f10b (database page ID, not collection ID)
 */

import { Client } from '@notionhq/client';

const notion = new Client({ auth: process.env.NOTION_TOKEN });
const DB_ID  = process.env.NOTION_CHEF_LEADS_DB_ID || 'dd28d06a-b2c8-4962-838c-a82707b1f10b';
